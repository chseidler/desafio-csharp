...
public class OrderDomainTests
{
    ...
    [Fact]
    public void StartPaymentProcess_ShouldChangeStateToProcessingPayment()
    {
        var order = new OrderDomain(Guid.NewGuid());
        var items = new List<(ItemDomain item, uint quantity)>
        {
    ...
    [Fact]
    public void StartPaymentProcess_ShouldThrowException_WhenNotInAwaitingProcessing()
    {
        var order = new OrderDomain(Guid.NewGuid());
        order.Create(new List<(ItemDomain item, uint quantity)>
        {
        ...
        Assert.Throws<InvalidOperationException>(() => order.StartPaymentProcess());
    }

    [Fact]
    public void CompletePayment_ShouldChangeStateToPaymentCompleted()
    {
        var order = new OrderDomain(Guid.NewGuid());
        var items = new List<(ItemDomain item, uint quantity)>
        {
    ...
    [Fact]
    public void FailPayment_ShouldChangeStateToCancelled()
    {
        var order = new OrderDomain(Guid.NewGuid());
        var items = new List<(ItemDomain item, uint quantity)>
        {
